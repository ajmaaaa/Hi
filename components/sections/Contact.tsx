 ...
 *   - True vertical centering achieved by placing the footer as an absolute element at the bottom.
...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative min-h-screen bg-[#070707] flex flex-col justify-center overflow-hidden text-white z-30"
    >
      {/* Main container - centered vertically in the viewport */}
      <div className="relative z-10 w-full max-w-[1536px] mx-auto px-8 lg:px-6 py-12 my-auto">
        <div className="flex flex-col lg:flex-row items-start justify-between w-full gap-16">
          ...
          <div className="flex flex-col gap-6 max-w-[580px] text-left lg:pl-[83px]">
            <motion.h2
              className="font-[family-name:var(--font-fredericka)] text-6xl sm:text-7xl lg:text-8xl tracking-[8px] uppercase text-white leading-none"
      ...
      {/* Footer Area — Positioned absolutely at the bottom for exact main-content centering */}
      {/* Brightened top border (border-white/20) and text colors for maximum legibility */}
      <div className="absolute bottom-8 left-0 right-0 w-full flex-shrink-0">
