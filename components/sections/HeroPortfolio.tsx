...
/**
 * Hero section: Perfectly aligned with the navbar grid.
 * Left text is aligned under the letter "Y" / "KY" of "MEYKY" in the navbar via px-6 + lg:pl-[72px].
 * Right polaroid cards are aligned with the rightmost edge of the navbar grid (Contact link).
 */
